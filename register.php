			...
			if($row['numrows'] > 0){
				...
				try{
				    ...
				    try {
				        ...
				        $mail->SMTPAuth = true;                               
				        $mail->Username = 'raselhossain120@gmail.com';     
				        ...
				        $mail->setFrom('raselhossain120@gmail.com','Rasel From Garibazar');
				        
				        //Recipients
				        $mail->addAddress($email);              
				        $mail->addReplyTo('raselhossain120@gmail.com');
				       
				        //Content
				        $mail->isHTML(true);                                  
				        $mail->Subject = 'Garibazar SignUp Activation';
				        $mail->Body    = $message;
